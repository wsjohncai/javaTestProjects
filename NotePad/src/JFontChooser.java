	...
	private void init(Font font, Color fcolor, Color bgcolor) {
		...
		bgotherColor.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				//new JColorChooser();
				Color col_temp = JColorChooser.showDialog(parent, "背景颜色", Color.WHITE);
				if (col_temp != null) {
		...
		fotherColor.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				new JColorChooser();
				Color col_temp = JColorChooser.showDialog(parent, "字体颜色", Color.BLACK);
				if (col_temp != null) {
