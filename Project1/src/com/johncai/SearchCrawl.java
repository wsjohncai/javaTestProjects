...
//搜索Web爬行者
public class SearchCrawl implements Runnable {
	/*
	 * disallowListCache缓存robot不允许搜索的URL。 Robot协议在Web站点的根目录下设置一个robots.txt文件,
	 * *规定站点上的哪些页面是限制搜索的。 搜索程序应该在搜索过程中跳过这些区域,下面是robots.txt的一个例子: # robots.txt
	 * for http://somehost.com/ User-agent: * Disallow: /cgi-bin/ Disallow:
	...
	public SearchCrawl(String startUrl, int maxUrl, String searchString) {
	...
	public static void main(String[] args) {
		...
		SearchCrawl crawler = new SearchCrawl(args[0], max, args[2]);
